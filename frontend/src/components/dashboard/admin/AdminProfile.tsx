            ...
            <div className="bg-white p-8 rounded-lg shadow-md max-w-2xl">
                ...
                <div className="space-y-4">
                    ...
                    <div className="border-t pt-4 mt-6">
                        <h3 className="text-lg font-semibold text-gray-700 mb-4">Admin Privileges</h3>
                        <div className="bg-purple-50 border border-purple-200 rounded-md p-4">
                            <p className="text-sm text-purple-800">
                                You have full administrative access to the CRM system, including client management,
                                system monitoring, and configuration settings.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="border-t pt-4 mt-6">
                        ...
                        <div className="flex space-x-4">
                            <button className="bg-purple-600 text-white font-bold py-2 px-4 rounded-md hover:bg-purple-700 transition-colors duration-300">
                                Edit Profile
                            </button>

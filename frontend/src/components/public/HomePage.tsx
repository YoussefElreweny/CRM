                                ...
                                {submitStatus === 'success' ? (
                                    ...
                                    <>
                                        ...
                                        <button
                                            ...
                                            className={`w-full bg-indigo-600 text-white font-bold py-3 px-6 rounded-lg hover:bg-indigo-700 transform active:scale-95 transition-all duration-200 shadow-md ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
                                        >
